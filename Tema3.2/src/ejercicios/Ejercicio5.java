...
public class Ejercicio5 {
	...
	public static void main(String[] args) {
		// Creamos la variable palabra para almacenar las palabras que va introduciendo
		// el usuario
		String palabra;
		...
		frase += palabra + " ";
		// Creamos un bucle while que finalizara cuando el usuario introduzca la palabra
		// fin
