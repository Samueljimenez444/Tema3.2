...
public class Ejercicio2 {
	...
	public static void main(String[] args) {
		//Creamos la variable contraseña que servira para almacenar la contraseña del jugador1
		String contraseña;
		//Creamos la variable jugdor que servira para almacenar la contraseña que elija el jugador2
		String jugador;
		//Creamos la variable entera comparador y la inicializamos a 1 esta variable servira para comparar alfabeticamente las dos contraseñas
		int comparador = 1;
		...
		//Comparador es igual a el numero (negativo positivo o cero) que sale despues de comparar alfabeticamente las cadenas
		comparador = contraseña.compareToIgnoreCase(jugador);
		//Mientras el comparador sea distinto a 0 (Es decir las contraseñas no sean iguales)
		while (comparador != 0) {
